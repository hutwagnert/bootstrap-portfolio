...
$(document).ready(function () {
    ...
    $(".character-row").on("click","#colum1", function () {
        ob = false;
    ...
    $(".character-row").on("click","#colum2", function () {
        sk = false;
    ...
    $(".character-row").on("click","#colum3", function () {
        ma = false;
        $("#colum1").contents().appendTo("#colum5");
    ...
    $(".character-row").on("click","#colum4", function () {
        sd = false;
        $("#colum1").contents().appendTo("#colum5");
        $("#colum2").contents().appendTo("#colum6");
    ...
    // move to 8
    $(".emimies-for").on("click","#colum5", function () {
        if ((col5) && (!ob)) {
